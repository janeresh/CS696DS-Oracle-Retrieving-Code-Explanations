...
# === CONFIG ===
csv_path = '/work/pi_wenlongzhao_umass_edu/27/anamikaghosh/Cosqa/pre_processing_COSQA/COSQA_cleaned_code.csv'
output_path = '/work/pi_wenlongzhao_umass_edu/27/anamikaghosh/Cosqa/output/COSQA_deepseek_explanations.csv'
checkpoint_path = '/work/pi_wenlongzhao_umass_edu/27/anamikaghosh/Cosqa/checkpoint/COSQA_deepseek.txt'
