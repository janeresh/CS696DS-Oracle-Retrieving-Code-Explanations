...
output_path = '/work/pi_wenlongzhao_umass_edu/27/anamikaghosh/Cosqa/output/COSQA_granite_explanations.csv'
checkpoint_path = '/work/pi_wenlongzhao_umass_edu/27/anamikaghosh/Cosqa/checkpoint/COSQA_granite.txt'
